...
import tm.payhas.crm.presentation.view.adapters.AdapterChecklist;
import tm.payhas.crm.presentation.view.adapters.AdapterSelectedUsers;
import tm.payhas.crm.presentation.view.adapters.AdapterTaskComments;
...
public class FragmentOneTask extends Fragment {
    ...
    private void initListeners() {
        ...
        b.editTask.setOnClickListener(view -> {
                    ...
                    addFragment(ActivityMain.mainFragmentManager, R.id.main_content, FragmentAddTask.newInstance(projectId, taskId));
        ...
        b.addChecklistClicker.setOnClickListener(view -> addFragment(ActivityMain.mainFragmentManager, R.id.main_content, FragmentAddChecklist.newInstance(taskId, projectId)));
    }
