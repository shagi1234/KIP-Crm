...
import tm.payhas.crm.presentation.view.fragment.FragmentOneProject;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(DataProject oneProject) {
            ...
            clicker.setOnClickListener(view -> {
                ...
                addFragment(ActivityMain.mainFragmentManager, R.id.main_content, FragmentOneProject.newInstance(oneProject.getId()));
