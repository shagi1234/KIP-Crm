...
import static tm.payhas.crm.fragment.FragmentOpenGallery.SINGLE;
...
import tm.payhas.crm.adapters.AdapterCreateGroup;
...
public class FragmentCreateGroup extends Fragment implements OnUserCountChangeListener {
    ...
    private void initListeners() {
        ...
        b.groupAvatarClicker.setOnClickListener(view -> {
            ...
            addFragment(mainFragmentManager, R.id.main_content, FragmentOpenGallery.newInstance(1, 0, SINGLE, 0));
