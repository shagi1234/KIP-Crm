...
import tm.payhas.crm.domain.model.DataBirthdays;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(DataBirthdays birthday) {
            ...
            clickablelayout.setOnClickListener(view -> {
                ...
                addFragment(ActivityMain.mainFragmentManager, R.id.main_content, FragmentUserInfo.newInstance(birthday.getUser().getId()));
